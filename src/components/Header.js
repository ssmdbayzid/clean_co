...
const Header = ({children}) => {
  ...
  <div className="drawer-content flex flex-col">
    ...
    <div className="w-full navbar fixed bg-base-100 px-3 z-50">
  ...
  <div className="drawer-side md:none lg:hidden">
    ...
    <li>
            <label onClick={()=>themeChange(false)} data-toggle-theme="dark,light" data-act-class="ACTIVECLASS" className="swap mr-auto swap-rotate text-sm hover:bg-transparent">
            <input type="checkbox" />
